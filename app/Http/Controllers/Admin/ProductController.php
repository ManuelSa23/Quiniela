...
class ProductController extends Controller
{
    ...
    public function getHome(){
        $products = Product::with('cat')->orderBy('id','Asc')->paginate(25);
    ...
    public function postProductAdd(Request $request){
        ...
        if($validator->fails()):
            ...
            $path = '/'.date('Y-m-d'); //Fecha de guardado
            ...
            return redirect('/admin/products')->with('message','Guardado con exito.')
    ...
    public function postProductEdit($id, Request $request){
        $rules = [
         ...
         if($validator->fails()):
             ...
             return back()->with('message','Actualizado con exito.')
             ->with('typealert','success');
         endif;
    }
}
